...
class TestCashFlowAnalyzer:
    ...
    def analyzer(self):
        ...
        config = CashFlowConfig(
            cash_accounts=['Chase Checking', 'Chase Credit Card', 'Apple Card'],
    ...
    def test_trend_statistics_calculation(self, analyzer, sample_ynab_data):
        ...
        required_keys = [
            ...
            'trend_line', 'daily_trend', 'monthly_trend', 'yearly_trend'
        ]
    ...
    def test_summary_statistics(self, analyzer, sample_ynab_data):
        ...
        required_keys = [
            'current_balance', 'monthly_trend', 'yearly_trend',
            'monthly_burn_rate', 'trend_direction', 'trend_confidence',
            'volatility', 'data_start_date', 'analysis_date'
        ]
        for key in required_keys:
            assert key in stats
    ...
    def test_empty_transactions_error(self, analyzer, temp_dir):
        ...
        accounts_data = {
            "accounts": [
                {"id": "1", "name": "Chase Checking", "balance": 50000000, "type": "checking"}
            ],
            "server_knowledge": 123
        }
...
class TestCashFlowEdgeCases:
    ...
    def test_missing_account_data(self, temp_dir):
        ...
        accounts_data = {
            "accounts": [
                {"id": "1", "name": "Other Account", "balance": 1000000}
            ],
            "server_knowledge": 123
        }
    ...
    def test_very_large_dataset(self, temp_dir):
        ...
        accounts_data = {
            "accounts": [
                {"id": "1", "name": "Test Account", "balance": 50000000}
            ],
            "server_knowledge": 123
        }
...
def test_full_cash_flow_workflow(temp_dir):
    ...
    config = CashFlowConfig(
        cash_accounts=['Checking', 'Credit Card'],
