...
from finances.apple.loader import filter_receipts_by_date_range, load_apple_receipts, receipts_to_dataframe
...
class TestAppleReceiptLoader:
    ...
    def test_load_receipts_from_valid_directory(self, sample_exports_dir):
        ...
        write_json(
            sample_exports_dir / "receipt1.json",
            {
                "order_id": "ML123ABC",
    ...
    def test_load_receipts_with_multiple_files(self, sample_exports_dir):
        ...
        write_json(
            sample_exports_dir / "receipt2.json",
            {
                "order_id": "ML222BBB",
    ...
    def test_receipts_to_dataframe_conversion(self, sample_exports_dir):
        ...
        write_json(
            sample_exports_dir / "receipt.json",
            {
                "order_id": "ML999ZZZ",
    ...
    def test_filter_receipts_by_date_range(self, sample_exports_dir):
        ...
        write_json(
            sample_exports_dir / "receipt_jan.json",
            {
                "order_id": "R_JAN",
        ...
        write_json(
            sample_exports_dir / "receipt_mar.json",
            {
                "order_id": "R_MAR",
